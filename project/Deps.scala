...
object Deps {
  ...
  val jsoniter = dep("com.github.plokhotnyuk.jsoniter-scala" %%% "jsoniter-scala-core" % "2.36.6")
  val zioJson = dep("dev.zio" %%% "zio-json" % "0.7.44")

  val http4s = dep("org.http4s" %%% "http4s-core" % "0.23.30")
}
